 ...
 */
/*
 * File: ICommandLineArgumentsService.java
 * Created: 2010-06-08
 * Author: kpietak
 * $Id: IRuntimeArgumentsService.java 4 2011-12-22 15:10:04Z faber $
 */
 ...
 * @author AGH AgE Team
 */
public interface IRuntimeArgumentsService {

	/**
	 * Returns platform (built-in) option by a given key.
	 * 
	 * @param key
	 *            key of a platform property
	 * @return required property or <code>null</code> if no option with given key exists
	 */
	 ...
	 * @param key
	 *            key of a platform property
	 * @return <code>true</code> if a platform property with given key exists, <code>false</code> otherwise
	 */
	 ...
	 * @param key
	 *            key of a custom property
	 * @return <code>true</code> if a custom property with given key exists, <code>false</code> otherwise
	 */
