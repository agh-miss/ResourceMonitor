 ...
 */
/*
 * File: AnyUsedSelectorTest.java
 * Created: 2009-04-21
 * Author: kpietak
 * $Id: AnyUsedSelectorTest.java 4 2011-12-22 15:10:04Z faber $
 */
...
public class AnyUsedSelectorTest extends AbstractAddressSelectorTest {
	...
	private AnyUsedSelector<IAgentAddress> selector;

	@Before
	public void setUp() {
		selector = new AnyUsedSelector<IAgentAddress>();
