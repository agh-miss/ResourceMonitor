 ...
 */
/*
 * File: ConfigNamespaces.java
 * Created: 2012-01-28
 * Author: Krzywicki
 * $Id: ConfigNamespaces.java 15 2012-01-29 07:43:32Z krzywick $
 */
...
public enum ConfigNamespaces {
	DEFAULT("age", "http://age.iisg.agh.edu.pl/AgE/2.5");

	private final String prefix;

	private final String uri;

	private ConfigNamespaces(String prefix, String uri) {
		this.prefix = prefix;
		this.uri = uri;
	}
